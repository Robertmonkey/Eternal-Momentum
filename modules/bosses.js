...
export const bossData = [{
    ...
    archetype: 'specialist',
    unlock_level: 40,
    core_desc: "Integrate the Overload's logic crash. A persistent shield now surrounds you; colliding with foes discharges an electromagnetic purge that vaporizes nearby projectiles and deletes fragile enemies. If the shield ever breaks, the purge still fires as it reboots.",
    ...
    archetype: 'field_control',
    unlock_level: 85,
    core_desc: "Channel for 4 seconds, then unleash an Annihilation Beam that blankets the arena. Anything not sheltered in a pillar-cast shadow suffers heavy, capped damage scaled to your foe—lethal to fodder, punishing but survivable for bosses.",
    ...
    archetype: 'field_control',
    unlock_level: 125,
    core_desc: "Enforce absolute law. When an Aberration manifests, four Containment Pylons rise at the arena's corners, linking into a slowing lattice that grinds intruders down as they cross its beams.",
    ...
    archetype: 'swarm',
    unlock_level: 130,
    core_desc: "Recursively analyze your own physical form, shrinking your size by 50% to increase your movement speed by 50%. Every tenth kill triggers a fractal mitosis, spawning three friendly fragments to harry your foes before collapsing.",
    ...
    archetype: 'swarm',
    unlock_level: 140,
    core_desc: "By remaining still, you allow your core to unspool the fabric of local reality, firing wide-arcing spirals that orbit farther out the longer you anchor yourself. Movement re-stabilizes the effect.",
    ...
    archetype: 'aggressor',
    unlock_level: 145,
    core_desc: "Upon receiving fatal damage, defy causality and rewind your personal timeline to your state from 2 seconds prior, negating death itself. This paradox can now be sustained every 12 seconds.",
    ...
    archetype: 'specialist',
    unlock_level: 150,
    core_desc: "Glimpse into shattered futures. At the start of each timeline, three Runes of Fate appear. Attune to one to claim a stage-long boon—then reality resumes, letting normal power-ups return to the field.",
