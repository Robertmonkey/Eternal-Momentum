...
export const bossData = [{
    ...
    archetype: 'swarm',
    unlock_level: 10,
    core_desc: "Upon defeating a non‑boss enemy, it shatters into 3 friendly, seeking fragments. This effect has a 0.5‑second cooldown.",
    ...
    archetype: 'aggressor',
    unlock_level: 20,
    core_desc: "Regenerate 2% of your max HP per second after 5 seconds out of harm’s way; each hit has a 10% chance to drop a blood orb healing 20% of max HP.",
    ...
    unlock_level: 25,
    core_desc: "Every 5 seconds you emit a pulse that repels foes and draws in power‑ups.",
    ...
    archetype: 'specialist',
    unlock_level: 35,
    core_desc: "On taking damage, spawn a decoy that periodically taunts enemies for 2 seconds on a 4–7 second cycle.",
    ...
    archetype: 'field_control',
    unlock_level: 45,
    core_desc: "Summon a ring of sixteen barriers for 10 seconds that enemies cannot cross—but you can.",
    ...
    archetype: 'specialist',
    unlock_level: 55,
    core_desc: "Spend 1 second aiming (stunned but invulnerable), then teleport to the cursor.",
    ...
    archetype: 'aggressor',
    unlock_level: 60,
    core_desc: "Charging for 1 second makes you unstoppable: then dash through enemies for 500 damage and knock back bosses.",
    ...
    archetype: 'swarm',
    unlock_level: 65,
    core_desc: "Every 4 seconds the farthest non‑boss enemy is converted into a friendly puppet; unlimited puppets.",
    ...
    archetype: 'specialist',
    unlock_level: 70,
    core_desc: "Contact with enemies has a 25% chance to erase them and spawn a random pickup.",
    ...
    archetype: 'field_control',
    unlock_level: 85,
    core_desc: "Channel for 4 seconds, then unleash a screen‑wide beam that vaporizes non‑bosses and deals 1000 damage to bosses.",
    ...
    archetype: 'swarm',
    unlock_level: 90,
    core_desc: "Touching enemies infects them; when they die, they release friendly spores.",
    ...
    archetype: 'field_control',
    unlock_level: 110,
    core_desc: "Standing still for 3 seconds emits a growing toxic cloud that heals you and damages enemies (30 HP/s).",
    ...
    archetype: 'specialist',
    unlock_level: 120,
    core_desc: "Attempting to use an empty inventory slot unleashes a cone‑shaped vacuum that pulls all power‑ups within its range toward you. This effect has a 1‑second cooldown.",
    ...
    archetype: 'swarm',
    unlock_level: 130,
    core_desc: "Shrink by 50% but move 50% faster; update collision and rendering accordingly.",
    ...
    archetype: 'swarm',
    unlock_level: 140,
    core_desc: "While stationary you automatically fire a large spiral bolt every second. Moving cancels the firing until you stand still again.",
    ...
    archetype: 'aggressor',
    unlock_level: 145,
    core_desc: "On lethal damage, rewind time to your last saved state (takes snapshots every 200 ms); 120 s cooldown.",
